...
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
        <meta name="description" content="Site responsivo css e html">
    ...
    <body>
        <header class="top-header clearfix">
            <div class="maxwidth">
            <img src="images/logo_mob.svg" alt="Logotipo Range Hotel" class="top-header-logo">
            <nav class="top-nav">
                <ul>
                    <li><a href="#">Home</a></li>
        ...
        <footer class="footer">
            <ul class="footer-menushare">
                ...
                <li><a href="#" class="icon-google-plus"><span class="hidden">Google +</span></a></li>
            </ul>
